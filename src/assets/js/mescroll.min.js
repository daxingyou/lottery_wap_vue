...
function() {
    ...
    a.prototype.extendDownScroll = function(b) {
        ...
        a.extend(b, {
            ...
            htmlContent: '<p class="downwarp-tip">下拉观看视频</p>',
            inited: function(d, c) {
            ...
            outOffset: function(c) {
                if (c.downTipDom) {
                	console.log(c.downTipDom)
                    c.downTipDom.innerHTML = "<div style='height:200px;width:100%;background:red' src='https://kj.kai861.com/view/video/PK10/video.html?10001?1682011.cn'>111</div>"
                }
            ...
            beforeLoading: function(d, c) {
           	 console.log(d.downHight)
             if(d.downHight<50){
				return false
             }else if(d.downHight>51){	 
				c.style.height=220+'px'
				return true
             }
    ...
    a.prototype.showTopBtn = function() {
        if (!this.topBtnShow) {
            ...
            if (c.toTopBtn == null) {
                ...
                if (d.supportTap) {
                    c.toTopBtn.addEventListener("tap",
                    function(f) {
                        f.stopPropagation();
                        f.preventDefault();
