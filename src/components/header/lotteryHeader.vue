<template>
  <div style="top:0">
    ...
    <header class="color1" :style="{'top': isIosWebview ? 40/40+'rem': 0}" ref="headZindex">
      ...
      <div>
        <i style="width: 1rem;height: 1rem;font-size:16px;margin: 0.2rem 0.4rem;float: right;" class="" @click.stop="isShowgame">
    ...
    <transition name="fade">
      <div v-show="isShow" class="header-is-active" @click="hideDailog">
        <div class="header-modal-content">
          <ul>
            <li ref="gamename" @click='gotoAddress(k)' v-for="(v,k) in lotteryGame">{{v}}
