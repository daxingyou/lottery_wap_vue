      ...
      subMit(){
        ...
        if(this.userName.length>0 && this.passWord.length>0){
          ...
          let href = window.location.href;
						if(href.indexOf("www.") > 0 || href.indexOf("wap.") > 0|| href.indexOf("m.") > 0) {
							href = href.split("//")[1];
							href = href.split("/")[0];
          ...
          this.$http.post(`${getUrl()}/user/signin`,JSON.stringify(params)).then(res => {
            ...
            if(res.data.msg==2001){
              this.promptboxtext = '账号/密码错误,你还有'+res.data.times+'次机会'
              this.panelShow = true
             ...
             this.promptboxshow=false
              ...
              setTimeout(()=>{
                ...
                this.successshow = true
	              ...
	              sessionStorage.setItem('im_telphone',JSON.stringify(res.data.telphone))
